...
export default function CompaniesListPage() {
  ...
  const rangeStart = processedCompanies.length === 0 ? 0 : startIndex + 1
  const rangeEnd = Math.min(endIndex, processedCompanies.length)
          ...
          processedCompanies.length > 0 && (
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between text-sm text-muted-foreground">
              <div className="flex items-center gap-3 flex-wrap">
                <span>Mostrando {rangeStart}–{rangeEnd} de {processedCompanies.length} empresas</span>
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('name')}>
                      <div className="flex items-center gap-1">Nome <SortIcon columnKey="name" /></div>
                    </TableHead>

                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('primaryContact')}>
                      <div className="flex items-center gap-1">Contato Principal <SortIcon columnKey="primaryContact" /></div>
                    </TableHead>

                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('type')}>
                      <div className="flex items-center gap-1">Tipo <SortIcon columnKey="type" /></div>
                    </TableHead>

                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('dealsCount')}>
                      <div className="flex items-center gap-1">Deals <SortIcon columnKey="dealsCount" /></div>
                    </TableHead>

                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('relationshipLevel')}>
                      <div className="flex items-center gap-1">Relacionamento <SortIcon columnKey="relationshipLevel" /></div>
                    </TableHead>

                    <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort('site')}>
                      <div className="flex items-center gap-1">Site <SortIcon columnKey="site" /></div>
                    </TableHead>
