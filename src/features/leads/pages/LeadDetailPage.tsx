...
// Helper to check if contact has any displayable info
const hasContactInfo = (contact: Contact | null): boolean => {
  if (!contact) return false
  return !!(contact.email || contact.phone || contact.linkedin)
}
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            {selectedContactForPreview?.linkedin && (
              <div className="flex items-center gap-3">
                <LinkedinLogo className="h-4 w-4 text-blue-600" weight="fill" />
                <a 
            ...
            {!hasContactInfo(selectedContactForPreview) && (
