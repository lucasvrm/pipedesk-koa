...
export default function PlayerDetailPage() {
  ...
  if (isLoading || isLoadingStages) return <PageContainer className="flex justify-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></PageContainer>
