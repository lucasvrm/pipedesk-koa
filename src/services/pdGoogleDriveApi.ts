...
// 🚨 KILL SWITCH: Forçando false temporariamente devido a erro 502 no backend Render
const REMOTE_ENABLED = false // Boolean(import.meta.env.VITE_PD_GOOGLE_BASE_URL)
...
if (typeof window !== 'undefined') {
  ...
  if (!REMOTE_ENABLED) {
    console.info(
      '[pdGoogleDriveApi] Integração remota desativada (KILL SWITCH ATIVO).'
    )
  }
}
