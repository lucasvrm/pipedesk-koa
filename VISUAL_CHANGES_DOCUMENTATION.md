...
### Visual Impact
- **Header:** Logo now consistently displays at 32px height (h-8 = 2rem = 32px)
- **Login:** Logo now consistently displays at 48px height (h-12 = 3rem = 48px) and is centered
...
│                             │
│       ╭───────────╮         │
│       │  🔒 Lock  │         │  ← Lock icon badge removed
│       ╰───────────╯         │
│                             │
│      [LOGO/PipeDesk]        │
│                             │
│  Acesso ao Sistema de       │  ← Old subtitle
│       DealFlow              │
│                             │
│  [Email Input]              │
│  [Password Input]           │
...
┌─────────────────────────────┐
│                             │
│      [LOGO/PipeDesk]        │  ← Cleaner, centered
│                             │
