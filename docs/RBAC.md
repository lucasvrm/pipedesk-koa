...
| `leads.*` | ✅ Enforced in DB (007/008) | ✅ Fully Enforced | Create/Update/Qualify buttons protected. |
| `contacts.*` | ✅ Enforced in DB (007/008) | ✅ Fully Enforced | Create/Edit/Delete buttons protected. |
| `companies.*` | ✅ Enforced in DB (007/008) | ⚠️ Partial | List page guarded by role, not permission. |
...
3.  **Companies**: Refactor `CompaniesListPage` to use permissions instead of role checks.
